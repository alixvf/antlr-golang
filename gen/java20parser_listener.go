...
type Java20ParserListener interface {
	...
	// EnterTryStatement1 is called when entering the TryStatement1 production.
	EnterTryStatement1(c *TryStatement1Context)

	// EnterTryStatement2 is called when entering the TryStatement2 production.
	EnterTryStatement2(c *TryStatement2Context)

	// EnterTryStatement3 is called when entering the TryStatement3 production.
	EnterTryStatement3(c *TryStatement3Context)

	// EnterTryStatement4 is called when entering the TryStatement4 production.
	EnterTryStatement4(c *TryStatement4Context)
	...
	// ExitTryStatement1 is called when exiting the TryStatement1 production.
	ExitTryStatement1(c *TryStatement1Context)

	// ExitTryStatement2 is called when exiting the TryStatement2 production.
	ExitTryStatement2(c *TryStatement2Context)

	// ExitTryStatement3 is called when exiting the TryStatement3 production.
	ExitTryStatement3(c *TryStatement3Context)

	// ExitTryStatement4 is called when exiting the TryStatement4 production.
	ExitTryStatement4(c *TryStatement4Context)
