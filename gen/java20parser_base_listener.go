...
// EnterTryStatement1 is called when production TryStatement1 is entered.
func (s *BaseJava20ParserListener) EnterTryStatement1(ctx *TryStatement1Context) {}

// ExitTryStatement1 is called when production TryStatement1 is exited.
func (s *BaseJava20ParserListener) ExitTryStatement1(ctx *TryStatement1Context) {}

// EnterTryStatement2 is called when production TryStatement2 is entered.
func (s *BaseJava20ParserListener) EnterTryStatement2(ctx *TryStatement2Context) {}

// ExitTryStatement2 is called when production TryStatement2 is exited.
func (s *BaseJava20ParserListener) ExitTryStatement2(ctx *TryStatement2Context) {}

// EnterTryStatement3 is called when production TryStatement3 is entered.
func (s *BaseJava20ParserListener) EnterTryStatement3(ctx *TryStatement3Context) {}

// ExitTryStatement3 is called when production TryStatement3 is exited.
func (s *BaseJava20ParserListener) ExitTryStatement3(ctx *TryStatement3Context) {}

// EnterTryStatement4 is called when production TryStatement4 is entered.
func (s *BaseJava20ParserListener) EnterTryStatement4(ctx *TryStatement4Context) {}

// ExitTryStatement4 is called when production TryStatement4 is exited.
func (s *BaseJava20ParserListener) ExitTryStatement4(ctx *TryStatement4Context) {}
